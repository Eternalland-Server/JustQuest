...
public class JournalList {
    ...
    public JournalList(List<String> quests) {
        this.UI = new ScreenUI("quest_journal_list");
        this.quests = quests;
    }
        ...
        for (int i = 0; i < quests.size(); i++) {
            ...
            UI
                    .addComponent(new TextureComp("q_" + i)
                            .setTexture("(global.quest_choose == " + i + ")?'ui/quest/line.png':'0,0,0,0'")
                            ...
                            .addAction(ActionType.Left_Click, new SubmitParams()
                                    .setCondition("(global.quest_choose != " + i + ")")
                                    .addValue(OperateCode.Choose_Quest.getID())
                                    .addValue(id)
                            )
                    )
                    .addComponent(new TextureComp("q_" + i + "_a")
                            .setTexture("(global.quest_choose == " + i + ")?'ui/quest/ss.png':'ui/quest/s.png'")
